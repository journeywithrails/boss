...
Project.configure do |project|
  ...
  project.email_notifier.emails = ['richard.zhou@sage.com', 'lastobelus@mac.com', 'chuck.leduc@sage.com', 'Philip.Wong@sage.com', 'wojciech@oxos.pl', 'daniel.vartanov@gmail.com' ]
   project.email_notifier.from = 'Tornado_AutoBuild@sage.com'
  ...
  project.rake_task = 'cont_integration_unit_test'
  #project.triggered_by SuccessfulBuildTrigger.new('tornado_test')
