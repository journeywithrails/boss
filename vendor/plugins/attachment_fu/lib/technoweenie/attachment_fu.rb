# added by mj, see http://blog.craigambrose.com/past/2007/9/9/migrating_from_file_column_to_attatchment_fu/
require 'mime/types'
...
module Technoweenie # :nodoc:
  module AttachmentFu # :nodoc:
    ...
    module InstanceMethods
      ...
      def image?
        return false if filename.blank? #RADAR: hack so that mangled records don't cause exceptions, just nothing will be displayed
      ...
      # writes the given base64 encoded data
      def temp_data64=(base64)
        self.temp_data = Base64.decode64(base64)
      end
