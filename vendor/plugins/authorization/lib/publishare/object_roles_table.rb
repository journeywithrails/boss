    ...
    module UserExtensions
      ...
      module ClassMethods
        def acts_as_authorized_user
          ...
          attr_protected :role_ids if accessible_attributes.nil?
      ...
      module InstanceMethods
        ...
        def has_no_role( role_name, authorizable_obj = nil, hook = true  )

          role_name = role_name.to_s
          role = get_role( role_name, authorizable_obj )
          var = false
          if role
            var = self.roles.delete( role )
            role.destroy if (role.users.empty? and hook)
          end
          return var
        end
    ...
    module ModelExtensions
      ...
      module ClassMethods
        def acts_as_authorizable
          ...
          attr_protected :accepted_role_ids if accessible_attributes.nil?
