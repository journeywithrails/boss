...
namespace :viget do
  ...
  namespace :deploy do
    ...
    task :post_update_code do
      # run "cp #{release_path}/config/database.sample.yml #{release_path}/config/database.yml"
      run "cp #{release_path}/config/mongrel_cluster-#{stage}.yml #{release_path}/config/mongrel_cluster.yml"
