module ActionView #:nodoc:
  ...
  class NoTemplateError < ActionViewError #:nodoc:
  end
...
If you are rendering a subtemplate, you must now use controller-like partial syntax:
  ...
  render :partial => 'signup' # no mailer_name necessary
      ...
      if use_full_path
        if template_extension
          ...
          unless template_extension
            raise NoTemplateError, "No template found for #{template_path} in #{view_paths.inspect}"
          end
      ...
      if template_file_name.blank?
        raise NoTemplateError, "Couldn't find template file for #{template_path} in #{view_paths.inspect}"
      end
